...
(function() {
    ...
    myConnector.getData = function(table, doneCallback) {
        ...
        var clientID = tableau.connectionName;
        console.log('Table is : '+table.tableInfo.id);
            
            const attendee_URL = "https://cors-anywhere.herokuapp.com/https://api.on24.com/v2/client/"+clientID+"/attendee";
            const registrant_URL = "https://cors-anywhere.herokuapp.com/https://api.on24.com/v2/client/"+clientID+"/registrant";
            const event_URL = "https://cors-anywhere.herokuapp.com/https://api.on24.com/v2/client/"+clientID+"/event";
            const survey_URL = "https://cors-anywhere.herokuapp.com/https://api.on24.com/v2/client/"+clientID+"/event";
...
async function ExecuteRequest(url, data) {
    ...
    // As this is a recursive function, we need to be able to pass it the previous data. Here we either use the passed in data, or we create a new objet to hold our data.
    data = data || {};
...
const attendee_promise = ExecuteRequest("https://cors-anywhere.herokuapp.com/https://api.on24.com/v2/client/"+clientID+"/attendee").then(data => {
...
if(table.tableInfo.id === 'Registrant') {
    ...
    const attendee_promise = ExecuteRequest("https://cors-anywhere.herokuapp.com/https://api.on24.com/v2/client/"+clientID+"/registrant").then(data => {
...
if(table.tableInfo.id === 'Event') {
  ...
  const event_promise = ExecuteRequest("https://cors-anywhere.herokuapp.com/https://api.on24.com/v2/client/"+clientID+"/event").then(data => {
...
if(table.tableInfo.id === 'Survey') {
    ...
    const survey_promise = ExecuteRequest("https://cors-anywhere.herokuapp.com/https://api.on24.com/v2/client/"+clientID+"/event/"+eventIDs[0]+"/survey").then(data => {
    ...
    $(document).ready(function() {
        $("#submitButton").click(function() {
            ...
            tableau.connectionName = clientID; // This will be the data source name in Tableau and carry Client ID
